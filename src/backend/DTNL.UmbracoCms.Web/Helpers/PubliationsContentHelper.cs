...
[Transient]
public class PubliationsContentHelper
{
    ...
    public PubliationsContentHelper(IContentTypeService contentTypeService)
    {
        ...
        string culture)
    {
        ...
        pageContent.SetValue<PagePublication>(p => p.Date, GetDateOrNull((string?) post.Element("pubDate")), culture);
        ...
        {
            pageContent.SetValue<PagePublication>(p => p.ContentTags, JsonSerializer.Serialize(new[] { category.Value }), culture);
        }
