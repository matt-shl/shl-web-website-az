// ReadOnlyTagsEditor:
//  This file was copied from ~\Umbraco-CMS\src\Umbraco.Web.UI.Client\src\common\directives\components\tags\umbtagseditor.directive.js
//  The only changes are denoted with a // CHANGE comment
//  The two changes on top make sure our component and template is loaded
//  The change deeper in the code makes sure to start autocomplete on focus, per customer request
...
(function () {
    ...
    angular
        ...
        .component('readOnlyTagsEditor', {          // CHANGE
            transclude: true,
            templateUrl: '/App_Plugins/ReadOnlyTagsEditor/read-only-tags.html',   // CHANGE
    ...
    function umbTagsEditorController($rootScope, assetsService, umbRequestHelper, angularHelper, $timeout, $element) {
        ...
        vm.inputId = "t" + String.CreateGuid();
        vm.isLoading = true;
        vm.tagToAdd = "";
